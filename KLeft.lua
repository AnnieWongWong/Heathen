...
--dialogue play, Hp update, scene change after pressing cross (self Created)
...
----dialogue play, HP update, scene change after clicking nocross (Self Created)
local function NoB()
