...
"You end up landing on your face and get a bloody nose", "But at least you made it to the other side",""}		     
...
local function NoB()
    ...
    if (c==#NoCross+1) then
    director:changeScene ("NKNoCross")
end
end
