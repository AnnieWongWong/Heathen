...
"OLD MAN : who you are....","OLD MAN : you are known throughout country, but you are no hero","OLD MAN : You were mentioned often but not by your real name, they called you by 'scum' 'heathen' 'heretic' and all kinds of other things",
"OLD MAN : You had gone missing for months and we believed that we had finally been blessed with your death.... but you are here","OLD MAN : you seem to have lost your memories .. how dare you forget all the sins you have commited","OLD MAN : If you wish to know more you must help me get out of thes damned cave first",
"OLD MAN : Don't worry it won't take long I've explored this cave many times before so I know the way out","OLD MAN :I shouldn't have gotten injured.. I know this cave like the back of my hand..... but the traps are new","OLD MAN : perhaps they were meant for you...",
"You help the old man up and he begins to direct you to the exit","a"}
local NoHelp = {"Getting yourself bandaged up and away from death as possible seems for important then helping the rude old man","But as you are about to run away, you realize that you might be missing out on an opporunity to learn about your past ", "Are you sure you want to leave the old man?", "a"}
local BackHelp = {"You won't immediately die if you use the supplies on the dying old man, so you go back and help","The old man bitterly thanks you and you question the old man of your past", "He spits blood intop your face", 
"OLD MAD : I saw what you did, you thought about stealing my supplies or yourself and leaving me to die","OLD MAN: You saved me for your own purpose did you not?","OLD MAN : and how dare you forget your past after all the sins yo uhave commited",
...
"OLD MAN : The are traps set in this cave that were not here before, probably meant to keep YOU in and other out", "He spits blood in your face again and begins to direct you to the exit","a"}
local NoHelp2 = {"This old man cannot be the only one who knows of your past","If only he had not cursed at you then maybe you would have considered saving him","OLD MAN : So you are who they say you are.....",
"OLD MAN : YOU SHOULD HAVE DIED.. THE WHOLE COUNTRY WANTED YOU DEAD, IN FACT WE ALL THOUGHT YOU WERE DEAD", "OLD MAN : BUT WHY ARE YOU HERE", "The old man coughs up puddles and puddles of blood","OLD MAN : I hope you burn in hell....", "His head dropped and he became quiet", 
"You know now that there are people out there who know who yoiu are, but would they react to your presence liek the old man did?", "You take the supplies abnd bandage yourself up before moving on",""}
...
local function BackHelpB()
    ...
    director:changeScene ("KBackHelp")
end
end
