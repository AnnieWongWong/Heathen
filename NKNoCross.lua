...
"As you blindly walk further and further you realize something","Who are you?",
 ...
 "In your view is an old man", "He appears to be bleeding excessively", "OLD MAN : help..... save me..... please",
...
"You help the old man up and he begins to direct you to the exit",""}
local NoHelp = {"Getting yourself bandaged up and away from death as possible seems more\n important then helping the rude old man","But as you are about to run away, you realize that you might be missing out\n on an opporunity to learn about your past ", "Are you sure you want to leave the old man?"}
local BackHelp = {"You won't die if you decide to use the supplies on the dying old man, so you\n go back and help","The old man bitterly thanks you and you question the old man of your past", "He spits blood into your face", 
"OLD MAN : I saw what you did, you thought about stealing my supplies for yourself\n and leaving me to die","OLD MAN : You saved me for your own purpose did you not?","OLD MAN : and how dare you forget your past after all the sins you have\n commited",
"OLD MAN : I will not tell you a word of who you are","OLD MAN : but if you help me out of this damned cave I might rethink that", " You help the old man up", 
"OLD MAN : There are traps set in this cave that were not here before, probably\n meant to keep YOU in and other out", "He spits blood in your face again and begins to direct you to the exit",""}
local NoHelp2 = {"This old man can't be the only one who knows of your past","If only he had not cursed at you maybe you would have considered\n saving him","OLD MAN : So you are who they say you are.....",
"OLD MAN : YOU SHOULD HAVE DIED.. THE WHOLE COUNTRY WANTED YOU DEAD,\n IN FACT WE ALL THOUGHT YOU WERE DEAD", "OLD MAN : BUT WHY ARE YOU HERE", "The old man coughs up puddles and puddles of blood","OLD MAN : I hope you burn in hell....", "His head drops and he becomes quiet", 
"You know now that there are people out there who know who you are, but\n would they react to your presence the same way the old man did?", "You take the supplies and bandage yourself up before moving on",""}
...
----dialogue play and scene change after pressing NoHelp (Self Created code)
local function NoB()
...
-- pressed go back and help option 
d=1
...
-- dialogue play of going back to help
local function BackHelpB()
    ...
    director:changeScene ("NKNCBackHelp")
end
end
...
local function noBackHelpB()
	...
	hp = "HP : 100"
     ...
     if (e == #NoHelp2+1) then
    director:changeScene ("NKNCNoHelp")
end
end
