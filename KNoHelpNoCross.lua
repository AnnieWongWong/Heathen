...
local cut = {"Since you are already so injured you decide that one more injury would be\n nothing", "with your rusty knife you begin to saw off your leg","It is not an easy task","the process is slow and painful","Once you free yourself you immedielty began to crawl out of the\n room","And...","You feel the light hit your face", "You are out",
...
-- option 1 dialogue play, background up date, scene change
local function cutB()
...
--option2 dialogue play , hp update , scene change
