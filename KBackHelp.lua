...
--pressing swim option (Self Created code)
b=1
...
--dialouge play, hp update, scene change, after pressing swim option (self created code)
...
-- Pressed no swim option (self Created code)
...
--dialouge play, hp update, scene change, after pressing noswim option (self created code
