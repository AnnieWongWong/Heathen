...
local swim = {"OLD MAN : I'm afraid that if we try to find a way around we may fall\n into a trap",
"You and the old man jump into the water and slowly swim across", "The old man arrogantly pushes you away whenever you try to help him swim",
 "when you reach the other side you realize the old man is missing","Will you go back to find him?"}
 local help = {"You swim back to look for the old man", " You find him struggling at the bottom of the lake and you bring\n him back up and across the lake", "OLD MAN: ....thank you"}
...
local function BackHelpB()
	...
	d=d+1
     ...
     if (d == #help+1) then
    director:changeScene ("Kwaterhelp")
end
end
